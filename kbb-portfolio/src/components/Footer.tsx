...
import { Phone, Mail, MapPin, Instagram, Stethoscope } from 'lucide-react';
            ...
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12 border-b border-slate-800 pb-16">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <p className="text-slate-400 leading-relaxed max-w-sm font-medium">
                            KBB ve Baş Boyun Cerrahisi alanında modern teknikler ve hasta odaklı yaklaşımla sağlığınızı önemsiyoruz.
                        </p>
                    </div>

                    <div className="space-y-6">
                        <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-500">İletişim</h4>
                        <div className="space-y-4">
                            <a href="tel:+905XXXXXXXXX" className="flex items-center gap-4 text-slate-400 hover:text-white transition group">
                    ...
                    <div className="space-y-6">
                        ...
                        <a href="https://instagram.com/dr.ibrahimunal" target="_blank" className="flex items-center gap-4 p-4 bg-slate-900 border border-slate-800 rounded-2xl hover:bg-slate-800 transition-all group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="font-bold text-sm text-white">@dr.ibrahimunal</span>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div className="mt-12 flex flex-col md:flex-row justify-between items-center gap-6 opacity-50">
                    <div className="text-[10px] font-black uppercase tracking-[0.2em]">
                        &copy; {new Date().getFullYear()} DR. İBRAHİM ÜNAL
                    </div>
